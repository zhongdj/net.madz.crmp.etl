...
public enum JdbcCascadeRule {
     ...
     */
    public final static JdbcCascadeRule getImportedKeyRule(Integer jdbcValue) {
        if ( null != jdbcValue ) {
            switch (jdbcValue) {
        ...
        throw new NoSuchElementException(JdbcCascadeRule.class.getSimpleName() + "[" + jdbcValue + "]");
    }
}
