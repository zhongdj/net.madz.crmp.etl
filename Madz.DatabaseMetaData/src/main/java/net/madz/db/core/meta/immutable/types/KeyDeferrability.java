...
public enum KeyDeferrability {
     ...
     */
    public final static KeyDeferrability getImportedDeferrability(Integer jdbcValue) {
        if ( null != jdbcValue ) {
            switch (jdbcValue) {
        ...
        throw new NoSuchElementException(KeyDeferrability.class.getSimpleName() + "[" + jdbcValue + "]");
    }
}
