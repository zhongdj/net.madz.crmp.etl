...
public enum ImportKeyDbMetaDataEnum {
    ...
    FKCOLUMN_NAME,
    /**
     * short => sequence number within a foreign key( a value of 1 represents
     ...
     * commit This controls whether the constraint can be deferred to the end of
     * the transaction. If SET CONSTRAINTS ALL DEFERRED is used or the
     * constraint is set to INITIALLY DEFERRED, this will cause the foreign key
     * to be checked only at the end of the transaction.
