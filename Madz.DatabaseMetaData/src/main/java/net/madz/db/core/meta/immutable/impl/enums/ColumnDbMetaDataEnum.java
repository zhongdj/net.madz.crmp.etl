...
public enum ColumnDbMetaDataEnum {
    ...
    BUFFER_LENGTH,
    /**
     * int => the number of fractional digits. Null is returned for data types
    ...
    NUM_PREC_RADIX,
    /**
     * int => is NULL allowed. columnNoNulls - might not allow NULL values
    ...
    REMARKS,
    /**
     * String => default value for the column, which should be interpreted as a
    ...
    SCOPE_SCHEMA,
    /**
     * String => table name that this the scope of a reference attribure (null
     * if the DATA_TYPE isn't REF)
     */
    SCOPE_TABLE,
    /**
     * short => source type of a distinct type or user-generated Ref type, SQL
     * type from java.sql.Types (null if DATA_TYPE isn't DISTINCT or
     * user-generated REF)
     */
    SOURCE_DATA_TYPE,
    /**
     * String => Indicates whether this column is auto incremented YES --- if
     * the column is auto incremented NO --- if the column is not auto
     * incremented empty string --- if it cannot be determined whether the
