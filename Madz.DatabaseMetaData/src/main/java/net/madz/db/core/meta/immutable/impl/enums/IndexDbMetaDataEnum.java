...
public enum IndexDbMetaDataEnum {
    ...
    COLUMN_NAME,
    /**
     * String => column sort sequence, "A" => ascending, "D" => descending, may
     * be null if sort sequence is not supported; null when TYPE is
     * tableIndexStatistic
     */
    ASC_OR_DESC,
    /**
     * int => When TYPE is tableIndexStatistic, then this is the number of rows
     * in the table; otherwise, it is the number of unique values in the index.
     */
    CARDINALITY,
    /**
     * int => When TYPE is tableIndexStatisic then this is the number of pages
