...
public abstract class ColumnMetaDataImpl<SMD extends SchemaMetaData<SMD, TMD, CMD, FMD, IMD>, TMD extends TableMetaData<SMD, TMD, CMD, FMD, IMD>, CMD extends ColumnMetaData<SMD, TMD, CMD, FMD, IMD>, FMD extends ForeignKeyMetaData<SMD, TMD, CMD, FMD, IMD>, IMD extends IndexMetaData<SMD, TMD, CMD, FMD, IMD>>
	...
	protected final IMD.Entry<IMD, CMD> primaryKey;
	protected final Collection<IMD.Entry<IMD, CMD>> uniqueIndexList;
	protected final Collection<IMD.Entry<IMD, CMD>> nonUniqueIndexList;
	...
	public ColumnMetaDataImpl(CMD metaData) {
		...
		this.uniqueIndexList = Collections.unmodifiableCollection(metaData
				.getUniqueIndexSet());
		this.nonUniqueIndexList = Collections.unmodifiableCollection(metaData
				.getNonUniqueIndexSet());
	}
	...
	@Override
	public Entry<IMD, CMD> getPrimaryKey() {
	...
	@Override
	public Collection<IMD.Entry<IMD, CMD>> getUniqueIndexSet() {
	...
	@Override
	public Collection<IMD.Entry<IMD, CMD>> getNonUniqueIndexSet() {
