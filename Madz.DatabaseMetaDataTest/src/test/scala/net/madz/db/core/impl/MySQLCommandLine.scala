...
trait MySQLCommandLine extends MySQLConnector {
  ...
  case class MySQLColumn(val tableName: String, val columnName: String, val ordinalPosition: Int, val columnDefault: String, val isNullable: Boolean,
    val dataType: String, val characterMaximumLengh: Long, val characterOctetLength: Long, val numberPrecision: Long, val numberScale: Long, val characterSetName: String, val collationName: String, val columnType: String, val columnKey: String, val extra: String, val columnComment: String)
